...
//____ЛСД_________________________________
#include <Wire.h> 
...
int zapusk=5;    //пин управления катушкой зажигания
int knop_pin=12;    //управление кнопкой энкодера
int urowen_up=3;    //верхний уровень масла
int urowen_down=4;   //нижний уровень масла
int podkach_pin=7;   //управление насосом подкачки
int cirkulacii_pin=6;  //циркуляионный насос
int nagrew_pin=1;      //управление теном нагрева масла

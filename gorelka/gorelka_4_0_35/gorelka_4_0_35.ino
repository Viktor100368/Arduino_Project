    ...
    if((t_oil<75)&&rabota_g)
  {
   ...
   digitalWrite(cirkulacii_pin,HIGH); //выключаем циркуляцию
    job=false;  //стоим, греемся
     ...
     //..........................................................запуск горелки
      if((t_water<=EEPROM.read(Water_min)) && job && !rabota_g && urowen )//если вода остыла, масло горячее и пламени нет  и анти_дым и уровень в норме
       {
